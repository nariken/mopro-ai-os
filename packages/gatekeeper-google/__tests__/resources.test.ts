...
describe("resource declarations", () => {
  ...
  it("advertises creation only on broad Drive resources", () => {
    expect([
      ...
      "Find files and folders, read native Google Docs and Sheets, and create blank Docs, Sheets, and folders anywhere this Google account can read in Drive, including shared drives it belongs to.",
