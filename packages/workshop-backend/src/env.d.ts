...
declare global {
  namespace Cloudflare {
    interface Env {
      ...
      // Use-only account usernames. Operators can open shared "use" workspaces, but cannot create
      // or configure workspaces, blueprints, connectors, outputs, or gatekeeper apps.
