...
function RootComponent() {
  ...
  // /demo/* is always standalone so screenshot layout does not depend on auth state.
  const standalone = isSignup || isDemo || (isBlueprint && !isAuthenticated)
  ...
  if (standalone) {
    const showHeader = !isSignup && !isDemo
    return (
      <TooltipProvider>
        <Toasty>
